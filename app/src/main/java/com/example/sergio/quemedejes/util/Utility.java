...
public class Utility {
     ...
     * @param routeId from OpenWeatherMap API response
     * @return resource id for the corresponding icon. -1 if no relation is found.
     */
    public static int getArtResourceForRouteCondition(String routeId) {
        if (routeId.contains("low")) {
            return R.drawable.ic_low_route;
        } else if (routeId.contains("medium")) {
            return R.drawable.ic_medium_route;
    ...
    public static String getFriendlyDayString(Context context, long dateInMillis) {
        ...
        // is "Today, June 24"
        if (System.currentTimeMillis() + 86400000 < dateInMillis) {
        ...
        } else if (System.currentTimeMillis() + 86400000 * 7 < dateInMillis ) {
    ...
    public static String getDayName(Context context, long dateInMillis) {
        ...
        } else if ( System.currentTimeMillis() + 86400000*2 < dateInMillis ) {
