...
package com.example.sergio.quemedejes.confapp.utils;

import android.content.Context;
import android.util.Log;

import com.appspot.quemedejes_001.conference.model.Conference;
import com.appspot.quemedejes_001.conference.model.ConferenceCollection;
import com.appspot.quemedejes_001.conference.model.Profile;
import com.appspot.quemedejes_001.conference.model.WrappedBoolean;
import com.example.sergio.quemedejes.confapp.AppConstants;
...
public class ConferenceUtils {
    ...
    private static com.appspot.quemedejes_001.conference.Conference sApiServiceHandler;
    ...
    /**
     * Returns a list of {@link com.example.sergio.quemedejes.confapp.utils.DecoratedConference}s.
     * This list includes information about what {@link com.appspot.quemedejes_001.conference.model.Conference}s
    ...
    public static List<DecoratedConference> getConferences()
        ...
        com.appspot.quemedejes_001.conference.Conference.QueryConferences
    ...
    /**
     * Registers user for a {@link com.appspot.quemedejes_001.conference.model.Conference}
     *
     * @param conference
     * @return
     * @throws ConferenceException
    ...
    public static boolean registerForConference(Conference conference)
        ...
        com.appspot.quemedejes_001.conference.Conference.RegisterForConference
    ...
    /**
     * Unregisters user from a {@link com.appspot.quemedejes_001.conference.model.Conference}.
     *
     * @param conference
     * @return
     * @throws ConferenceException
    ...
    public static boolean unregisterFromConference(Conference conference)
        ...
        com.appspot.quemedejes_001.conference.Conference.UnregisterFromConference
    ...
    /**
     * Returns the user {@link com.appspot.quemedejes_001.conference.model.Profile}. Can
    ...
    public static Profile getProfile() throws ConferenceException, IOException {
        ...
        com.appspot.quemedejes_001.conference.Conference.GetProfile getProfile =
                sApiServiceHandler.getProfile();
        return getProfile.execute();
    }

    /**
     * Build and returns an instance of {@link com.appspot.quemedejes_001.conference.Conference}
     *
     * @param context
     * @param email
     * @return
     */
    public static com.appspot.quemedejes_001.conference.Conference buildServiceHandler(
            Context context, String email) {
        GoogleAccountCredential credential = GoogleAccountCredential.usingAudience(
                context, AppConstants.AUDIENCE);
        credential.setSelectedAccountName(email);

        com.appspot.quemedejes_001.conference.Conference.Builder builder
                = new com.appspot.quemedejes_001.conference.Conference.Builder(
